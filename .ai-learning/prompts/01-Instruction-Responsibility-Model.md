...
Every material Instruction Responsibility MUST be describable through the following minimum semantic contract.
...
What decisions, interpretations, recommendations, or state changes the responsibility is permitted to make or perform.

Detailed authority semantics belong to `02-Instruction-Authority-and-Composition.md`.

## 27.8 Excluded Authority

What decisions, interpretations, recommendations, or state changes explicitly remain outside the responsibility's authority.

Excluded authority MUST remain explicit where ambiguity could cause authority leakage into a neighboring semantic domain.

Detailed authority and composition semantics belong to `02-Instruction-Authority-and-Composition.md`.

## 27.9 Context Requirements

What context is required or relevant for correct behavior.

Detailed context authority, provenance, freshness, and truth semantics belong to `03-Context-and-Truth-Contracts.md`.

## 27.10 Output Semantics

What kinds of outputs the responsibility may produce and what semantic status those outputs possess.

Detailed output semantics belong to `06-Instruction-Outputs-Claims-and-Stage-5-Contracts.md`.

## 27.11 Claim Boundary

What factual, evaluative, completion, or state-related claims the responsibility is permitted to make, and which claims remain outside its authority.

A responsibility MUST NOT infer claim authority merely from its ability to observe, generate, or consume relevant information.

Detailed claim semantics belong to `06-Instruction-Outputs-Claims-and-Stage-5-Contracts.md`.

## 27.12 Evidence Requirements

What evidence is required before the responsibility may make material claims within its authority.

Evidence requirements MUST preserve the distinction between evidence availability and authority to interpret that evidence.

Detailed evidence and claim requirements belong to `06-Instruction-Outputs-Claims-and-Stage-5-Contracts.md`.

## 27.13 Neighboring Responsibilities

Which other responsibilities materially interact with it.

## 27.14 Separation Requirements

Which neighboring responsibilities MUST remain semantically distinguishable.

## 27.15 Composition Eligibility

Which responsibilities MAY be safely composed, subject to Stage 4 authority and composition rules.
